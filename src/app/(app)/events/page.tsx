...
import { collection, query, orderBy, addDoc, serverTimestamp, doc, runTransaction } from 'firebase/firestore';
  ...
  const handleScanSuccess = async (scannedData: string) => {
    ...
    try {
        ...
        await runTransaction(firestore, async (transaction) => {
            ...
            transaction.set(doc(attendanceRef), newAttendance);
        ...
        toast({
            ...
            description: 'Es posible que ya hayas registrado tu asistencia para este evento.',
        });
    }
